 ...
 */
final class Version20220517044146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_product (id INT NOT NULL, app_order_id INT NOT NULL, product_id INT NOT NULL, quantity INT NOT NULL, price_per_one NUMERIC(10, 0) NOT NULL, PRIMARY KEY(id))');

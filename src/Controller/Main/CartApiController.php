...
class CartApiController extends AbstractController
{
    ...
    public function saveCart(Request $request, CartRepository $cartRepository, CartProductRepository $cartProductRepository,
                             ManagerRegistry $doctrine, ProductRepository $productRepository): Response
    {
